...
const correctInputValueLength = () => inputClassList.contains("invalid") ?
    inputClassList.replace("invalid", "valid") :
    inputClassList.add("valid");
const incorrectInputValueLength = () => inputClassList.contains("valid") ?
    inputClassList.replace("valid", "invalid") :
    inputClassList.add("invalid");

const onCheckInputLength = () => inputEl.value.length == INPUT_LENGTH ?
    correctInputValueLength() :
    incorrectInputValueLength();
